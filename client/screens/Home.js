        ...
        return (
            this.state.accepted ?
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={{ height: 95, width: 190, paddingTop: 40, paddingBottom: 10, flexDirection: 'column', justifyContent: 'center', alignContent: "flex-end" }}>
                        <Text>"I have and agree with the Privacy Policy and Terms of Service" - You</Text>
                    </View>
                    <View>
                        <TouchableOpacity>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={{  width: 190, paddingTop: 40, paddingBottom: 10, flexDirection: 'column', justifyContent: 'center', alignContent: "flex-end" }}>
